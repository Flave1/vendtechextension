...
namespace vendtechext.DAL.Migrations
{
    ...
    [Migration("20250901111822_MigrationUniqueId")]
    partial class MigrationUniqueId
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("vendtechext.DAL.Models.AppUser", b =>
                {
                    ...
                    b.Property<string>("MigrationUniqueId")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("vendtechext.DAL.Models.Country", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("vendtechext.DAL.Models.Deposit", b =>
                {
                    ...
                    b.HasIndex("CommissionDepositId");
            ...
            modelBuilder.Entity("vendtechext.DAL.Models.RolePermission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("vendtechext.DAL.Models.Wallet", b =>
                {
                    ...
                    b.Property<bool>("IsBalanceLowReminderSent")
                        .HasColumnType("bit");

                    b.Property<int>("MidnightBalanceAlertSwitch")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("vendtechext.DAL.Models.AppRole", b =>
                {
            ...
            modelBuilder.Entity("vendtechext.DAL.Models.Deposit", b =>
                {
                    b.HasOne("vendtechext.DAL.Models.Deposit", "CommissionDeposit")
                        .WithMany()
                        .HasForeignKey("CommissionDepositId");
                    ...
                    b.Navigation("CommissionDeposit");
            ...
            modelBuilder.Entity("vendtechext.DAL.Models.RolePermission", b =>
                {
                    b.HasOne("vendtechext.DAL.Models.AppRole", "Role")
                        .WithMany()
                        .HasForeignKey("RoleId");
